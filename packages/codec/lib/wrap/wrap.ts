...
//for arrays, tuples, and tx options.  all other types get their
//own file.
...
export function* wrap(
  ...
  switch (dataType.typeClass) {
    ...
    case "function":
      ...
      //otherwise, go ahead
      return yield* wrapWithCases(dataType, input, wrapOptions, functionExternalCases);
    case "array":
...
function* optionsFromOptionsValue(
  dataType: Format.Types.OptionsType,
  input: unknown,
  wrapOptions: WrapOptions
